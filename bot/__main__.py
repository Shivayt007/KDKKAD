...
def start(update, context):
    ...
    buttons.buildbutton("Report Group", "https://t.me/trvpn")
...
'''
        ...
        sendMarkup('Not Authorized user, TTK', context.bot, update, reply_markup)
...
def main():
    ...
    if os.path.isfile(".restartmsg"):
        ...
        bot.edit_message_text("SERVER LOAD IS HIGH!!", chat_id, msg_id)
        os.remove(".restartmsg")
    elif OWNER_ID:
        try:
            text = "<b> SERVER Restarted!</b>"
